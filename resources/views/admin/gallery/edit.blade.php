...
<div class="">
  <div class="">
    ...
    <div class="card p-2">
      <div class="">
        <a href="" class="">
          <h2 class="brand-text text-primary">{{__('Edit gallery')}}</h2>
        </a>

        <form class="form-group" method="POST" action="{{ route('admin.gallery.update', ['id' => $item->id]) }}" enctype="multipart/form-data">
        @method('PUT')  
        @csrf
        <div class="row">
        ...
        <div class="row">
            <div class="form-group col-lg">
                ...
                <input value="{{ $item->name }}" type="text" class="form-control @error('name[uz]') is-invalid @enderror" id="register-name[uz]" name="name[uz]" placeholder="name[uz]" aria-describedby="register-name[uz]" tabindex="1" autofocus value="{{ old('name[uz]') }}" />
                @error('name[uz]')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-lg">
                ...
                <input value="{{ $item->name }}" type="text" class="form-control @error('name[ru]') is-invalid @enderror" id="register-name[ru]" name="name[ru]" placeholder="name[ru]" aria-describedby="register-name[ru]" tabindex="1" autofocus value="{{ old('name[ru]') }}" />
                @error('name[ru]')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
            ...
            <div class="form-group col-lg">
                ...
                <input value="{{ $item->name }}" type="text" class="form-control @error('name[en]') is-invalid @enderror" id="register-name[en]" name="name[en]" placeholder="name[en]" aria-describedby="register-name[en]" tabindex="1" autofocus value="{{ old('name[en]') }}" />
                @error('name[en]')
                <span class="invalid-feedback" role="alert">
                  <strong>{{ $message }}</strong>
                </span>
